...
WHERE company = 'Oda'
;
-- it looks like these are all legitimate entries and shouldn't be deleted. Really look at every single row to be accurate
...
-- these are the ones I want to delete where the row number is > 1 or 2 or greater 
...
-- if I look at industry it looks like I have some null and empty rows, I'll take a look at these
...
-- everything looks good except apparently I have some "United States" and some "United States." with a period at the end. I'll standardize this.
